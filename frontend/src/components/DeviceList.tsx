...
import { Monitor, Trash2, PencilLine, Plus, RefreshCw, KeyRound, Lock } from "lucide-react";
...
export function DeviceList({
  ...
  return (
    <aside className="w-64 flex-shrink-0 bg-slate-900 border-r border-slate-700 flex flex-col h-full">
      {/* Header */}
