...
from backend.routers import audit_router, auth_router, auth_2fa_router, config_transfer_router, devices_router, ftp_router, keys_router, sftp_router, terminal_router
